...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestimonialPhoto'
        db.create_table('testimonials_testimonialphoto', (
            ('file_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['files.File'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('testimonials', ['TestimonialPhoto'])

        # Adding field 'Testimonial.image'
        db.add_column('testimonials_testimonial', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['testimonials.TestimonialPhoto'], null=True),
                      keep_default=False)


        # Changing field 'Testimonial.creator'
        db.alter_column('testimonials_testimonial', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Testimonial.entity'
        db.alter_column('testimonials_testimonial', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'Testimonial.owner'
        db.alter_column('testimonials_testimonial', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'TestimonialPhoto'
        db.delete_table('testimonials_testimonialphoto')

        # Deleting field 'Testimonial.image'
        db.delete_column('testimonials_testimonial', 'image_id')


        # Changing field 'Testimonial.creator'
        db.alter_column('testimonials_testimonial', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Testimonial.entity'
        db.alter_column('testimonials_testimonial', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Testimonial.owner'
        db.alter_column('testimonials_testimonial', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'testimonials.testimonial': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'testimonials_testimonial_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'testimonials_testimonial_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['testimonials.TestimonialPhoto']", 'null': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'testimonials_testimonial_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'testimonials.testimonialphoto': {
            'Meta': {'object_name': 'TestimonialPhoto', '_ormbases': ['files.File']},
        ...
        'user_groups.group': {
            ...
            'group': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': "orm['auth.Group']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
